<div class="row mt-3">
    <div class="col-sm-12">
        <div class="connect-sorting">
            @can('3.1 Venta Denominaciones')
                <h5 class="text-center mb-2">DENOMINACIONES</h5>
                <div class="container">
                    <div class="row">
                        @foreach ($denominations as $d)
                            <div class="col-sm mt-2">
                                <button wire:click.prevent="ACash({{ $d->value }})" class="btn btn-dark btn-block">
                                    {{ $d->value > 0 ? '$' . number_format($d->value, 0, '.', ',') : 'Exacto' }}
                                </button>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="card simple-title-task ui-sortable-handle">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between mt-5">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                @if ($efectivo >= $total && $total > 0 && $item->quantity > 0)
